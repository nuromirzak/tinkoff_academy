...
public interface BotCommands {
    ...
    List<BotCommand> LIST_OF_COMMANDS = List.of(
        new BotCommand(COMMAND_START, "Регистрация пользователя"),
        new BotCommand(COMMAND_HELP, "Получить список доступных команд"),
        new BotCommand(COMMAND_TRACK, "Подписаться на рассылку"),
        new BotCommand(COMMAND_UNTRACK, "Отписаться от рассылки"),
        new BotCommand(COMMAND_LIST, "Вывести список отслеживаемых ссылок")
    );

    String COMMAND_START_RESPONSE =
        "Добро пожаловать в бота, %s! Вы успешно зарегистрировались, для подробной информации введите команду /help";
    ...
    String COMMAND_HELP_RESPONSE = """
        ...
        """;
    String COMMAND_TRACK_RESPONSE =
        "Вы успешно подписались на ссылку %s, теперь вы будете получать уведомления о изменениях";
    String ERROR_MESSAGE_NO_LINKS =
        "У вас нет отслеживаемых ссылок, для получения списка доступных команд введите команду /help.";
    String ERROR_MESSAGE_LINK_NOT_ADDED = "Не было добавлено ссылок, возможно вы уже отслеживаете эту ссылку.";
    String COMMAND_UNTRACK_RESPONSE =
        "Вы успешно отписались от ссылки %s, теперь вы не будете получать уведомления о изменениях";
    ...
    String COMMAND_DELETE_RESPONSE =
        "Вы успешно отписались от всех ссылок и от бота, для получения списка доступных команд введите команду /help.";
    String ERROR_MESSAGE_NOT_REGISTERED =
        "Вы должны быть зарегистрированы, для получения списка доступных команд введите команду /help.";
    ...
    String ERROR_MESSAGE_COMMAND_NOT_FOUND =
        "Введите команду для получения списка доступных команд введите команду /help.";
