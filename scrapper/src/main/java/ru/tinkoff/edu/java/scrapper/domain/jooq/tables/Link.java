...
public class Link extends TableImpl<LinkRecord> {
     ...
     * этой ссылкой
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_UPDATED =
            createField(DSL.name("LAST_UPDATED"), SQLDataType.LOCALDATETIME(6).nullable(false), this,
    ...
    public final TableField<LinkRecord, LocalDateTime> LAST_SCRAPPED = createField(DSL.name("LAST_SCRAPPED"),
            SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this,
    ...
    public final TableField<LinkRecord, JSON> JSON_PROPS = createField(DSL.name("JSON_PROPS"), SQLDataType.JSON, this,
            "Дополнительные свойства ссылки в формате JSON");
