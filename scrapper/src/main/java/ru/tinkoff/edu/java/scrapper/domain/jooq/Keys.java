...
public class Keys {
    ...
    public static final UniqueKey<LinkChatRecord> CONSTRAINT_4 = Internal.createUniqueKey(LinkChat.LINK_CHAT, DSL.name("CONSTRAINT_4"), new TableField[] { LinkChat.LINK_CHAT.CHAT_ID, LinkChat.LINK_CHAT.LINK_ID }, true);

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<LinkChatRecord, LinkRecord> CONSTRAINT_47 = Internal.createForeignKey(LinkChat.LINK_CHAT, DSL.name("CONSTRAINT_47"), new TableField[] { LinkChat.LINK_CHAT.LINK_ID }, Keys.CONSTRAINT_2, new TableField[] { Link.LINK.LINK_ID }, true);
}
